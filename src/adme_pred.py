"""SOURCED ENTIRELY FROM https://github.com/ikmckenz/adme-pred-py/blob/master/adme_pred/adme_pred.py
I was having trouble getting the conda installation to work.
Everything that follows is from the https://github.com/ikmckenz/adme-pred-py/tree/master
with its corresponding license.
